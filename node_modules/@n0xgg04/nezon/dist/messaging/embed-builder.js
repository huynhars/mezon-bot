...
class EmbedBuilder {
    ...
    addAnimatedImage(options) {
        const { id = 'animated_image', name = '', value = '', imageUrl, positionUrl, pool, repeat = 1, duration = 0.35, isResult, extra, } = options;
        const component = {
            url_image: imageUrl,
        ...
        this.fields.push({
            ...
            inputs: {
                id,
                type: mezon_sdk_1.EMessageComponentType.ANIMATION,
                component,
            },
        });
        return this;
    ...
    setDescriptionMarkdown(description, options) {
     ...
     * ```
     */
    addTextField(name, inputId, options) {
        const component = {
            id: inputId,
        };
     ...
     * ```
     */
    addSelectField(name, inputId, options, selectedValue) {
