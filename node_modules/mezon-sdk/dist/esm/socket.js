...
export class DefaultSocket {
    ...
    async removeChatMessage(clan_id, channel_id, mode, is_public, message_id, topic_id) {
        const response = await this.send({
    ...
    async updateChatMessage(clan_id, channel_id, mode, is_public, message_id, content, mentions, attachments, hideEditted, topic_id, is_update_msg_topic) {
    ...
    async writeEphemeralMessage(receiver_id, clan_id, channel_id, mode, is_public, content, mentions, attachments, references, anonymous_message, mention_everyone, avatar, code, topic_id, message_id) {
        try {
            const response = await this.send({
