...
export class MezonClientCore extends EventEmitter {
    ...
    initManager(basePath, sessionApi) {
        ...
        this.socketManager = new SocketManager(this.host, this.port, this.useSSL, new WebSocketAdapterPb(), this.apiClient, this.messageQueue, this, this.messageDB);
        ...
        if (!userCache && allDmChannels) {
            ...
            userIds.forEach((id) => {
                ...
                if (this.users.get(id))
                    return;
                const user = new User({ id, dmChannelId: allDmChannels?.[id] ?? "" }, {
                    socketManager: this.socketManager,
                    messageQueue: this.messageQueue,
                    channelManager: this.channelManager,
                });
