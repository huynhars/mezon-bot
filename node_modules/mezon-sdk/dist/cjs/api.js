...
const rate_limit_manager_1 = require("./mezon-client/manager/rate-limit_manager");
const GLOBAL_LIMITER = new rate_limit_manager_1.RateLimiter(1024);
class MezonApi {
    ...
    rateLimitFetch(fullUrl, fetchOptions) {
        return GLOBAL_LIMITER.schedule(async () => {
            const controller = new AbortController();
            const t = setTimeout(() => controller.abort(), this.timeoutMs);
            try {
                return await fetch(fullUrl, Object.assign(Object.assign({}, fetchOptions), { signal: controller.signal }));
            }
            catch (e) {
    ...
    mezonHealthcheck(bearerToken, options = {}) {
        ...
        return this.rateLimitFetch(fullUrl, fetchOptions).then((res) => this.handleResponse(res));
    }
